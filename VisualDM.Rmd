...
Make a new shiny app to link the two plots from the "All Models Example" from slides 11-12 (the scatterplot of R2 vs df, and the parallel coordinate plot of the coefficients)
