...
TP1 <- fish %>% 
        ...
        ggplot(aes(x=height, y=length3, 
           ...
           geom_hline(yintercept=29.5,color="#7570B3") +
  scale_colour_brewer("", palette="Dark2")
...
TP2<- fish %>% 
        ...
        ggplot(aes(x=height, y=width, 
           ...
           geom_hline(yintercept=14.4, color="#7570B3") +
  scale_colour_brewer("", palette="Dark2")
...
TP3<- fish %>% 
        ...
        ggplot(aes(x=height, y=weight, 
          ...
          geom_hline(yintercept=109.95,color="#7570B3") +
  scale_colour_brewer("", palette="Dark2")
...
## Exploring a random forest ensemble
